# Generated by Powerlevel10k configuration wizard on 2020-12-11 at 10:24 CST.
...
() {
  ...
  # typeset -g POWERLEVEL9K_BACKGROUND=214
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=069
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=069
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=069
  ...
  ##############[ taskwarrior: taskwarrior task count (https://taskwarrior.org/) ]##############
  # Taskwarrior color.
  typeset -g POWERLEVEL9K_TASKWARRIOR_FOREGROUND=069
